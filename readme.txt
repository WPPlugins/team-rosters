...
The primary enhancements in version 4.1 are:
 
* Added admin screens to add players to and edit players on a roster in bulk (pagainated groups of 20 players).
* Teams may now be linked to teams in the MSTW League Manager database, in addition to the MSTW Schedules & Scoreboards database. 
* The display settings for team logos, and default search order for logos have been updated.
* The plugin remains translation ready, and is now aligned with [the new WordPress "polygots" translation process] (https://translate.wordpress.org/).
