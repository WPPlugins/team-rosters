 ...
 *-------------------------------------------------------------------------*/
	...
	//mstw_tr_log_msg( 'in single-player.php ... ' );
 ...
 ?>
	...
	<div id="primary">
		...
		<!-- Add the back link -->
		<nav id="nav-single">
			<h3 class="assistive-text"><?php _e( 'Post navigation', 'team-rosters' ); ?></h3>
		...
		//mstw_tr_log_msg( 'mstw_tr_build_team_colors_html( ) ... returned:' );
		//mstw_tr_log_msg( $hidden_fields );
		echo $hidden_fields;
