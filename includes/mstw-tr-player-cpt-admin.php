	...
	function mstw_tr_create_player_screen( $post ) {
		...
		$admin_fields = array ( 
						...
						'player_year' => array (
							'type' => 'text',
							'curr_value' => $year,
							'label' => $options['year_label'] . ':',
							'maxlength' => $std_length,
							'size' => $std_size,
							'desc' => __( 'This field is intended for the player\'s year in school, for example, "Freshman", "10" (10th grade), or "Redshirt Soph". It can be changed by changing the Year Label in the settings screen.', 'team-rosters' ),
							),
						'player_experience' => array (
							'type' => 'text',
							'curr_value' => $experience,
							'label' => $options['experience_label'] . ':',
							'maxlength' => $std_length,
							'size' => $std_size,
						...
						'player_last_school' => array (
							...
							'label' => $options['last_school_label'] . ':',
							'maxlength' => $std_length,
							'size' => $std_size,
						...
						'player_other' => array (
							'type' => 'text',
							'curr_value' => $other,
							'label' => $options['other_info_label'] . ':',
							'maxlength' => $std_length,
							'size' => $std_size,
