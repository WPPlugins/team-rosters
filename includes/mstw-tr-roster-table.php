 ...
 *-------------------------------------------------------------------------*/
 ...
 if ( !function_exists( 'mstw_tr_roster_table_handler' ) ) {
	function mstw_tr_roster_table_handler( $atts = null ){
		...
		//mstw_tr_log_msg( 'in mstw_tr_roster_table_handler ... ' );
		//mstw_tr_log_msg( 'table shortcode arguments=' );
		//mstw_tr_log_msg( $atts );
		...
		//mstw_tr_log_msg( '$roster_type= ' . $roster_type );
		...
		//mstw_tr_log_msg( 'calling mstw_tr_build_roster_table() with $attribs:' );
		//mstw_tr_log_msg( $atts );
		//mstw_tr_log_msg( $attribs );
 ...
 if( !function_exists( 'mstw_tr_build_roster_table' ) ) {
	function mstw_tr_build_roster_table( $team, $roster_type, $attribs ) {
		...
		//mstw_tr_log_msg( 'in mstw_tr_build_roster_table ...' );
		//mstw_tr_log_msg( 'roster table shortcode arguments=' );
		//mstw_tr_log_msg( $atts );
 ...
 if( !function_exists( 'mstw_tr_add_player_name' ) ) {
	function mstw_tr_add_player_name( $post, $args ) {
		...
		//mstw_tr_log_msg( 'in mstw_tr_add_player_name ... $args:' );
		//mstw_tr_log_msg( $args );
